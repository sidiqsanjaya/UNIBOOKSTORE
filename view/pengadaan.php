    ...
    <div class="container">
        <header class="d-flex flex-wrap justify-content-center py-3 mb-4 border-bottom">
            ...
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a href="<?php echo $config['base_url']; ?>?p=pengadaan" class="nav-link active">Pengadaan</a></li>
            </ul>
        </header>
    </div>
    <div class="container">
        ...
        <table id='thome' class="table table-bordered table-striped">
            ...
            <tbody>
                <?php
                foreach (pengadaan() as $dpengadaan) {
                ?>
                    <tr>

                        <td><?php out($dpengadaan['Nama_Buku']); ?></td>
                        <td><?php out($dpengadaan['Nama']); ?></td>
                        <td><?php out($dpengadaan['Stok']); ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
